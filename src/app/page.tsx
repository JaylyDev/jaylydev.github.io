...
function ContactList() {
  return (
    <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-2 lg:text-left">
      ...
      >
        <Image src={"/images/youtube_icon.svg"} alt={"YouTube Icon"} width={100} height={100}></Image>
      ...
      <a
        ...
        rel="noopener noreferrer"
      >
        <Image src={"/images/mcpedl_logo_1024.png"} alt={"MCPEDL Icon"} width={70} height={70}></Image>
        <h2 className={`mb-3 text-2xl font-semibold`}>
          MCPEDL{" "}
          <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
            -&gt;
      ...
      <a
        ...
        rel="noopener noreferrer"
      >
        <Image src={"/images/github-mark-white.svg"} alt={"GitHub Icon"} width={70} height={70}></Image>
        <h2 className={`mb-3 text-2xl font-semibold`}>
          GitHub{" "}
          <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
            -&gt;
      ...
      <a
        ...
        rel="noopener noreferrer"
      >
        <Image src={"/images/discord_icon.svg"} alt={"Discord Icon"} width={90} height={70}></Image>
        <h2 className={`mb-3 text-2xl font-semibold`}>
          Discord{" "}
          <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
            -&gt;
  ...
  return (
    <div className="flex min-h-fit flex-col items-center p-12" id="youtube">
      ...
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed?listType=playlist&list=UUguD3-nPXTVY6CHw3F1HWvw"
...
function CurrentProjects() {
  return (
    <>
      ...
      <Padding size={48} />
      <div
        className="flex min-h-fit flex-col text-content"
        style={{
          fontSize: "1.1rem",
        }}
      >
        <li>
          <strong>
            ScriptAPI Examples [{hyperlink({ url: "https://github.com/JaylyDev/ScriptAPI", text: "GitHub" })}]
          </strong>
          <br />
        ...
        <li>
          <strong>
            ScriptAPI Docs [{hyperlink({ url: "/scriptapi-docs", text: "Website" })}] [
            {hyperlink({ url: "https://github.com/JaylyDev/scriptapi-docs", text: "Source Code" })}]
          </strong>
          <br />
          My own ScriptAPI documentation site, with versioned API references.
        </li>
        <br />
        <li>
          <strong>JaylyBot</strong>
          <br />A Discord bot that mainly debug your Minecraft scripts.
        </li>
        <br />
        <li>
          <strong>
  ...
  return (
    <>
      ...
      >
        ...
        <br></br>
        <br></br>I have made various Add-Ons on MCPEDL since 2018, and videos on YouTube
        <br></br>since 2019.
...
export default function Home() {
  return (
    <main>
      ...
      <div className="flex min-h-screen flex-col items-center justify-between bg-gradient-to-b from-indigo-600 via-blue-900 to-transparent">
        <ContactList />
      </div>
      <CurrentProjects />
      <div className="p-5" />

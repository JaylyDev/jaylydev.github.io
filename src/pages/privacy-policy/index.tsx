...
import { createTranslateFunction, getStaticLocaleProps, LocaleProps, ScreenLocaleProps } from "@/locale/i18n";
    ...
    <div className="content" style={{ marginTop: "50px" }}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to JaylyMC.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>Administered by: Third-Parties</p>
          <p>
            Purpose: These Cookies track your browsing habits to enable Us to show advertising which is more likely to
            be of interest to You. These Cookies use information about your browsing history to group You with other
            users who have similar interests. Based on that information, and with Our permission, third party
      ...
      <h3>Analytics</h3> <p>We may use third-party Service providers to monitor and analyze the use of our Service.</p>
      <ul>
        <li>
          <p>
      ...
      <ul>
        <li>
          ...
          <p>
            ...
            DoubleClick cookie enables it and its partners to serve ads to our users based on their visit to our Service
      ...
      <h2>GDPR Privacy</h2> <h3>Legal Basis for Processing Personal Data under GDPR</h3>
...
export const getStaticProps: GetStaticProps<LocaleProps> = async () => {
  ...
  return {
    props: await getStaticLocaleProps("en", "privacyPolicy", fs, path),
  };
};

export default function Post({ texts }: ScreenLocaleProps): JSX.Element {
  const t = createTranslateFunction(texts); // Do not translate privacy policy for now
  return (
    <>
      <Head>

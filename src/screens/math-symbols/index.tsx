...
export default function Page({ texts, lang }: ScreenLocaleProps): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>Glossary of Math Symbols for Microsoft Word | JaylyDev</title>
        <meta
          name="description"
          content="Complete list of Math Symbols, codes and their keywords used in Microsoft 365 apps, including Word, Excel, PowerPoint, and many more."
        />

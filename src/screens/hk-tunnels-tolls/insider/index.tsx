...
export default function Page({ texts }: ScreenLocaleProps): JSX.Element {
  const t = createTranslateFunction(texts);
  return (
    <>
      <Head>
        <title>香港實時隧道收費（測試版） | JaylyDev</title>
        <meta
          name="description"
          content="即時提供香港實時三條過海隧道（西隧、東隧、紅隧）和大欖隧道收費資訊。測試版App，可能會有錯誤或不穩定。"
        />
        <meta property="og:type" content="article" />
        <meta property="og:image" content="https://jaylydev.github.io/hk-tunnels-tolls/icon.png" />
        <meta property="og:locale" content="zh_HK" />
        <meta name="apple-mobile-web-app-title" content="香港隧道收費測試版" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta property="twitter:card" content="summary" />
      </Head>
      <StatsCollection />
      <SiteHeader t={t} lang="zh" />
      <InArticleAdUnit />
      <HeroUIProvider>
        <ThemeProvider>
          <HKTunnelsTollsApp />

...
export const defaultConfig: Config = {
  classNameMaps: {
    block: (title) => {
      switch (title) {
        case 'NOTE': return 'markdown-alert markdown-alert-note'
        case 'IMPORTANT': return 'markdown-alert markdown-alert-important'
        case 'WARNING': return 'markdown-alert markdown-alert-warning'
        case 'TIP': return 'markdown-alert markdown-alert-tip'
        case 'CAUTION': return 'markdown-alert markdown-alert-caution'
        default: return 'markdown-alert';
      }
    },

...
2. Search for "Minecraft" and select "Minecraft for Windows". The download link is available at [Microsoft Store](https://apps.microsoft.com/detail/9NBLGGH2JHXJ?hl=en-us&gl=US&ocid=pdpshare) or on [Xbox Store](https://www.xbox.com/en-GB/games/store/minecraft-for-windows/?ocid=storeforweb), or you can use the Minecraft Launcher to install it.
...
3. Copy the contents of your backed-up `com.mojang` folder, except the `minecraftWorlds` folder itself, into this new directory, replacing any existing files. This is the new place where addons, resource packs, and behavior packs are stored.

![Copy addons](/assets/posts/bedrock-gdk/copy-addons.png)

4. If you have worlds to restore, navigate to the `%AppData%\Minecraft Bedrock\Users\<randomnumbers>\games\com.mojang` directory, and copy your backed-up `minecraftWorlds` folder into this location. This is where your worlds are now stored.

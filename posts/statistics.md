...
The amount of damage the player has absorbed in health points (1 heart = 2 health points).

### Damage Dealt

The amount of damage the player has dealt in health points (1 heart = 2 health points).

This includes every damage cause dealt by the player.

### Damage Taken

The amount of damage the player has taken in health points (1 heart = 2 health points).

This includes every damage cause taken by the player.

### Dispensers Searched

The number of times player has interacted with dispensers.
